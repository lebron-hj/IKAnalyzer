...
public class IKQueryExpressionParser {
	...
	public static void main(String[] args){
		...
		final int threadCount = threadPoolCount*1;
...
//					testInstanceDefaultConfig();
			...
			private void testInstanceDefaultConfig(){
				singleton = DefaultConfig.getInstance(res);
				singleton.getResourceLoader();
				if (singleton != DefaultConfig.getInstance(res)) {
...
//				System.err.println("一个线程执行完毕！");
			...
			private void testInstanceDirectory(){
				System.out.println(DefaultConfig.getInstance(null));
			}
